...
openGrid begins with a grid of 28mm spaces called a **Board**. The size of the board can vary and is determined by you; multiple boards can be connected and composed, allowing your setup to grow as needed. See the [Boards](/guides/board) page for more info.

Within the spaces of a board, you can attach **Snaps**. Snaps are the key building block for attaching boards to surfaces, and attaching things to boards. Attachments might snap directly into a board, or you might use a Multiconnect snap, opening the way to a large ecosystem of already tried and trusted attachments. See the [Snaps](/guides/snaps) page for more info.

## Ready to start

Jump into the system with our [quickstart guide](/guides/quickstart/)!
