...
openGrid provides a wide range of different snap types. The ones shown here are only meant to be
...
Use the bare snap that fits your need the best. Use the lite version when you want to support the lite and
full board versions of openGrid. Note that the lite snaps use only 3.4mm of the 4mm openGrid board thickness, you can attach two of those into the same full tile from both sides.
